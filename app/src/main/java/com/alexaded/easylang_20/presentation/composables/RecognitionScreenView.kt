...
import com.alexaded.easylang_20.adapters.SelectedLangAdapter
import com.alexaded.easylang_20.models.DataModel
import com.alexaded.easylang_20.models.SelectedLangModel
import com.alexaded.easylang_20.presentation.activities.SaveActivity
import com.alexaded.easylang_20.presentation.activities.TranslateActivity
...
import kotlinx.android.synthetic.main.layout_translate_to.*
import java.io.File
...
open class RecognitionScreenView : AppCompatActivity(), View.OnClickListener, ClickLang {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cardView_translate_from.setOnClickListener(this)
    ...
    override fun onClick(view: View?) {
        when(view?.id){
            ...
            R.id.cardView_translate_to ->{
                dialog = Dialog(this)
                dialog.setContentView(R.layout.layout_translate_to)
                dialog.rv_select_language.layoutManager = LinearLayoutManager(this)
                dialog.rv_select_language.setHasFixedSize(true)
                languageAdapter = SelectedLangAdapter(this,this,languageModelList)
                ...
                when {
                    ...
                    languageCodeOfTranslateTo.isNullOrEmpty() -> {
                        ...
                        intent.putExtra(TRANSLATE,
                            DataModel(0,languageCodeOfTranslateFrom,languageCodeOfTranslateTo,blockArrayList,translatedArrayList, saveImageUri.toString()))
                        startActivity(intent)
                    }
                }
            }
...
// set translateFrom text
    ...
    override fun onSelectedLanguageClicked(languageModel: SelectedLangModel) {
        tv_translate_to.text = languageModel.langName
        languageCodeOfTranslateTo = languageModel.langId
        dialog.cancel()
    }
